classdef Util
  % --------------------------------------------------------------------------------------
  % This class contains some useful methods used for data visualization.
  %
  ...
  methods(Static)
    ...
    function plotClasses(arg1,arg2)
      % ----------------------------------------------------------------------------------
      % This class is used to plot 2D point classes.
      % ----------------------------------------------------------------------------------      
      if nargin==1
        data = arg1;
      elseif nargin==2
      ...
      for i=1:num_classes
        if data{i}.y==num_classes % outlier
    ...
    function plotClassesAux(xtrain,ytrain,xlimits,ylimits)
      % ----------------------------------------------------------------------------------
      % This class is a second way of plotting 2D point classes.
      % ----------------------------------------------------------------------------------            
      if nargin==2
        xlimits = [-1.0,1.0];
        ylimits = [-1.0,1.0];
    ...
    function plotDecisionBoundary(xtest,predictions,color,xlimits,ylimits)
      % ----------------------------------------------------------------------------------
      % This class is used to plot decision boundaries.
      % ----------------------------------------------------------------------------------                  
      if nargin==2
        xlimits = [-1.0,1.0];
        ylimits = [-1.0,1.0];
    ...
    function viewHyperparameterCalibration(arg1,arg2,arg3,arg4)
      % ----------------------------------------------------------------------------------
      % This class is used to view hyperparameter calibration.
      % ----------------------------------------------------------------------------------
      if nargin==3
        metric_name = arg1;
        hyperparameter = arg2;
    ...
    function metrics = compareMetricsPerTest(out_dir,method,K,kappa)
      % ----------------------------------------------------------------------------------
      % This class is used to compare accuracy metrics for test experiments.
      % ----------------------------------------------------------------------------------      
      switch method
        case {'knn','lmnn'}
    ...
    function boxPlotMetricsPerMethod(out_dir,methods,K,kappa)
      % ----------------------------------------------------------------------------------
      % This class is used to visualize boxplots related to accuracy metrics comparison 
    ...
    function plotDecisionBoundaryMethods()
      % ----------------------------------------------------------------------------------
      % This class is used to visualize the decision boundaries generated by 
      % novelty detection methods when applied to synthetic datasets.
      % ----------------------------------------------------------------------------------      
      close all;
