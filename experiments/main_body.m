...
lmnn_config.decision_thresholds = linspace(0.1,1.5,lmnn_config.num_decision_thresholds)';

% KLMNN
klmnn_config.name = 'klmnn';
klmnn_config.num_decision_thresholds = num_decision_thresholds;
klmnn_config.decision_thresholds = linspace(0.8,3.7,klmnn_config.num_decision_thresholds)';
...
klmnn_config.kernels = linspace(0.6,2,klmnn_config.num_kernels)';

% KNFST
knfst_config.name = 'knfst';
knfst_config.num_decision_thresholds = num_decision_thresholds;
knfst_config.decision_thresholds = linspace(0.1,0.7,knfst_config.num_decision_thresholds)';
knfst_config.kernel_type = 'gauss';
knfst_config.num_kernels = num_kernels;
knfst_config.kernels = linspace(0.2,3.5,knfst_config.num_kernels)';

% ONE SVM
one_svm_config.name = 'one_svm';
one_svm_config.kernel_type = 'gauss';
one_svm_config.num_kernels = num_kernels;
one_svm_config.kernels = linspace(0.05,1.5,one_svm_config.num_kernels)';

% MULTI SVM
multi_svm_config.name = 'multi_svm';
multi_svm_config.num_decision_thresholds = num_decision_thresholds;
multi_svm_config.decision_thresholds = linspace(0.5,1.0,multi_svm_config.num_decision_thresholds)';
multi_svm_config.kernel_type = 'gauss';
multi_svm_config.num_kernels = num_kernels;
multi_svm_config.kernels = linspace(1,4,multi_svm_config.num_kernels)';
