...
knn_config.decision_thresholds = linspace(0.1,1.1,knn_config.num_decision_thresholds)';
...
klmnn_config.decision_thresholds = linspace(0.1,1.5,klmnn_config.num_decision_thresholds)';
...
klmnn_config.kernels = linspace(0.5,1.5,klmnn_config.num_kernels)';

% KNFST
knfst_config.name = 'knfst';
knfst_config.num_decision_thresholds = num_decision_thresholds;
knfst_config.decision_thresholds = linspace(0.22,0.35,knfst_config.num_decision_thresholds)';
knfst_config.kernel_type = 'gauss';
knfst_config.num_kernels = num_kernels;
knfst_config.kernels = linspace(0.15,0.25,knfst_config.num_kernels)';

% ONE SVM
one_svm_config.name = 'one_svm';
one_svm_config.kernel_type = 'gauss';
one_svm_config.num_kernels = num_kernels;
one_svm_config.kernels = linspace(1.2,1.5,one_svm_config.num_kernels)';
...
multi_svm_config.kernels = linspace(2.5,4.0,multi_svm_config.num_kernels)';
...
kpca_config.kernels = linspace(0.01,0.6,kpca_config.num_kernels)';
