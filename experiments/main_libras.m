...
knn_par.decision_thresholds = linspace(0.5,1.5,knn_par.num_thresholds)';

% LMNN
lmnn_par.num_thresholds = 50;
lmnn_par.decision_thresholds = linspace(0.5,1.5,lmnn_par.num_thresholds)';

% KLMNN
klmnn_par.num_thresholds = 50;
klmnn_par.decision_thresholds = linspace(0.5,1.5,klmnn_par.num_thresholds)';
...
knfst_par.decision_thresholds = linspace(0.5,0.8,knfst_par.num_thresholds)';
...
multi_svm_par.decision_thresholds = linspace(0.01,0.8,multi_svm_par.num_thresholds)';
...
kpca_par.decision_thresholds = linspace(0.8,1.0,kpca_par.num_thresholds)';
...
switch tutorial
  case 1
    ...
    % ------------------------------------------------------------------------------------
    manager.runExperimentsForKnnMethods(methods([1,2,3]),hyperparameters([1,2,3]));  
  case 2
    % ------------------------------------------------------------------------------------
