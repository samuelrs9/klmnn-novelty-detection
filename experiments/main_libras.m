...
manager = Manager(X,y,out_dir,parameters,num_experiments,...
...
switch tutorial
  case 1
    ...
    % ------------------------------------------------------------------------------------
    manager.runExperimentsForKnnMethods(methods([1,2,3]));  
  case 2
    % ------------------------------------------------------------------------------------
    % Process novelty detection results for KNN, LMNN, and KLMNN based methods.
    % ------------------------------------------------------------------------------------
    manager.reportExperimentsForKnnMethods(K,kappa);
  case 3
    % ------------------------------------------------------------------------------------
  ...
  case 4
    ...
    % based methods.
    % ------------------------------------------------------------------------------------    
    manager.reportExperimentResults();
end
