...
knn_config.decision_thresholds = linspace(0.1,1.5,knn_config.num_decision_thresholds)';

% LMNN
lmnn_config.name = 'lmnn';
lmnn_config.num_decision_thresholds = num_decision_thresholds;
lmnn_config.decision_thresholds = linspace(0.1,2.5,lmnn_config.num_decision_thresholds)';

% KLMNN
klmnn_config.name = 'klmnn';
klmnn_config.num_decision_thresholds = num_decision_thresholds;
klmnn_config.decision_thresholds = linspace(0.1,3.5,klmnn_config.num_decision_thresholds)';
...
knfst_config.decision_thresholds = linspace(0.01,0.2,knfst_config.num_decision_thresholds)';
...
one_svm_config.kernels = linspace(1.0,3.0,one_svm_config.num_kernels)';    
...
multi_svm_config.kernels = linspace(5.0,10.0,multi_svm_config.num_kernels)';

% KPCA
kpca_config.name = 'kpca';
kpca_config.num_decision_thresholds = num_decision_thresholds;
kpca_config.decision_thresholds = linspace(0.1,1.0,kpca_config.num_decision_thresholds)';
kpca_config.kernel_type = 'poly'; % offset = 1.0;
kpca_config.num_kernels = num_kernels;
kpca_config.kernels = linspace(1,10,kpca_config.num_kernels)';    
