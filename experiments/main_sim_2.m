...
out_dir = 'out_sim_2';
data = SyntheticDatasets.parabolas(out_dir,false);
xtrain = data.X;
ytrain = data.y;
xtest = data.xtest;
ytest = data.ytest;
...
klmnn_config.decision_thresholds = linspace(0.1,3.0,klmnn_config.num_decision_thresholds)';
...
knfst_config.decision_thresholds = linspace(0.001,0.2,knfst_config.num_decision_thresholds)';
...
one_svm_config.kernels = linspace(0.8,2.0,one_svm_config.num_kernels)';    
...
kpca_config.decision_thresholds = linspace(0.9,1.0,kpca_config.num_decision_thresholds)';
kpca_config.kernel_type = 'poly'; 
kpca_config.num_kernels = num_kernels;
kpca_config.kernels = linspace(5.0,10.0,kpca_config.num_kernels)';    
