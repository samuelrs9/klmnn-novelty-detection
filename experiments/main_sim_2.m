...
if search_parameters
    ...
    one_svm_par.kernel = linspace(0.8,2.0,one_svm_par.n_kernels)';
    ...
    kpca_par.threshold = linspace(0.9,1.0,kpca_par.n_thresholds)';
    kpca_par.kernel_type = 'poly';
    kpca_par.n_kernels = 10;     
    kpca_par.kernel = linspace(5.0,10.0,kpca_par.n_kernels)';
    ...
    Methods.runValidations(X,y,methods([2]),parameters,out_dir,n_experiments,...
    ...
    Methods.runEvaluations(xtrain,ytrain,xtest,ytest,methods([2]),out_dir,n_classes,K,kappa);
