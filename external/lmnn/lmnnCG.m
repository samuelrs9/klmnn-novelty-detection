...
try
    ...
    fprintf('\n****************************\n')
    fprintf('Sorry, lmnnCG.m threw an error.');
    fprintf(sprintf('If this is not easily fixable, please feel free to email me at <a href="mailto:kilian@gmail.com">kilian@gmail.com</a>.'));
    fprintf('Please don''t forget to paste the following error message into the email:');  
    rethrow(lasterror);
end
